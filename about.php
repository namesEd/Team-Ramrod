...
<html lang="en">
    ...
    <body>
        ...
        <h1 class="text-center mb-5 display-5">Meet Our Team</h1>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="card shadow cards">
                        <img class="card-img-top rounded-circle mx-auto mt-4" src="images/gz.jpg" alt="Card image cap">
                        <div class="card-body text-center">
                            <h4 class="card-title">Geno Zepeda</h4>
                                <p class="card-text">
                                    <h5><em>Frontend</em></h5>
